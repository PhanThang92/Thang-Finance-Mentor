        ...
        {value ? (
          ...
          <div>
            <div style={{ position: "relative", display: "inline-block" }}>
              <img
                ...
                alt=""
                style={{
                  display: "block", width: "240px", height: "135px",
              ...
              <div style={{ position: "absolute", top: "6px", right: "6px", display: "flex", gap: "5px" }}>
                ...
                <button
                  ...
                  style={{
                    padding: "4px 10px", borderRadius: "5px", border: "none",
                    background: "rgba(193,51,51,0.82)", color: "#fff",
                    fontSize: "11px", cursor: "pointer", fontWeight: 500,
                  }}
                >
                  Xóa ảnh
              ...
              <div style={{ marginTop: "8px", display: "flex", alignItems: "center", gap: "8px" }}>
                <img
                  ...
                  style={{
                    ...
                    borderRadius: "5px", border: `1px solid ${A.border}`,
                    display: "block",
                  }}
                />
            ...
            {phase === "uploading" && (
              <p style={{ margin: "6px 0 0", fontSize: "12px", color: A.textMuted }}>Đang tải ảnh lên...</p>
            )}
          </div>
        ) : (
          /* ── Empty / upload state ── */
          <button
            ...
            style={{
              ...
              width: "240px", height: "135px", borderRadius: "8px",
              border: `2px dashed ${phase === "uploading" ? A.primary : A.border}`,
              background: phase === "uploading" ? "rgba(26,120,104,0.04)" : "#f9fafb",
              cursor: phase === "uploading" ? "not-allowed" : "pointer",
              gap: "8px", transition: "border-color 0.15s ease",
            }}
          >
            {phase === "uploading" ? (
              <>
                <span style={{ fontSize: "16px", color: A.primary }}>◌</span>
                <span style={{ fontSize: "12px", color: A.primary }}>Đang xử lý ảnh...</span>
              </>
            ) : (
              <>
                <span style={{ fontSize: "22px", color: A.primary, lineHeight: 1 }}>↑</span>
                <span style={{ fontSize: "12px", fontWeight: 600, color: A.primary }}>Tải ảnh lên</span>
                <span style={{ fontSize: "10.5px", color: A.textLight, textAlign: "center", lineHeight: 1.4 }}>
